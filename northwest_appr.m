...
if d_sum > s_sum
    ...
    X = [ X ; dummy];% adding dummy supply i.e adding a row
end
...
% The table has been balanced and now we can start with our northwest
% corner method
i = 2; j = 2; % i and j will be used as an indices to proceed in this method
